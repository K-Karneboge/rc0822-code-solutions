...
console.log('the author of book 2 is ', bookshelf[1].author);
console.log('the ISBN of book 1 is ', bookshelf[0].isbn);
console.log('the title of book 3 is ', bookshelf[2].title);
