...
export default class App extends React.Component {
  ...
  handleSubmit(event) {
    ...
    fileFormData.append('caption', this.state.caption);
    fileFormData.append('image', this.fileInputRef.current.files[0]);
    fetch('api/uploads', { method: 'POST', body: fileFormData })
